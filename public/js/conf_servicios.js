    ...
    $.ajax({
        ...
        success: function(res, status, xhr) {
            res.data.map(function(servicio) {   
                ...
                let planE = servicio.id_plan_ejercicio;
                let planS = servicio.id_plan_suplemento;
                ...
                let row = $(`<tr>
                    ...
                    <td id="precio-${servicio.id_servicio}">${servicio.precio.valor} ${servicio.precio.unidad.simbolo}</td>
